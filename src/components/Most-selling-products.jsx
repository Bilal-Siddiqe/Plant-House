        ...
        <div className="container">
            ...
            <div className='mt-3 pt-3 row'>
                ...
                <div className="msp-text col-lg-6 ms-5 ps-5">
                    <h1 className='mt-5 pt-5 ms-5 ps-5'>Most selling plants</h1>
                    <p className='mt-5 ms-5 ps-5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque at asperiores eligendi modi, tempora porro perspiciatis quas cumque expedita facilis earum, hic esse! Itaque distinctio quas odio minima illum sequi?</p>
                    <button className="btn btn-success btn-lg mt-5 ms-5 ps-5 px-5 py-3 fw-bolder">Explain More Plants</button>
                </div>
            </div>
